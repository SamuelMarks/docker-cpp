...
int v() {
    /*auto r = cpr::Get(cpr::Url{"https://api.github.com/repos/whoshuu/cpr/contributors"},
                      ...
                      cpr::Parameters{{"anon", "true"},
                                      {"key",  "value"}});
    std::cout << "r.status_code:\t" << r.status_code
              << "\t\tr.headers[\"content-type\"]:\t" << r.header["content-type"]
              << "\t\tr.text:\t" << r.text << std::endl;
  */
    ...
    im.imageListSync("", true, "", false, "", nullptr);*/
    return 1;
}
